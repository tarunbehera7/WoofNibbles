        ...
        <>
            ...
            <div className="admin-container">
                ...
                <main className="admin-main">
                    ...
                    <div className="admin-overview">
                        <div className="overview-card">
                            <i className='bx bx-cart' style={{ fontSize: '24px', color: '#4CAF50' }}></i> 
                            <h3>Total Orders</h3>
                            <p>{orders.length}</p> 
                        </div>
                        <div className="overview-card">
                            <i className='bx bx-user' style={{ fontSize: '24px', color: '#2196F3' }}></i>
                            <h3>Total Users</h3>
                            <p>8</p>
                        </div>
                        <div className="overview-card">
                            <i className='bx bx-box' style={{ fontSize: '24px', color: '#ff9800' }}></i>
                            <h3>Total Products</h3>
                            <p>10</p>
                        </div>
                        <div className="overview-card">
                            <i className='bx bx-dollar' style={{ fontSize: '24px', color: '#8BC34A' }}></i>
                            <h3>Revenue</h3>
                            <p>
                              ₹ { orders
